...
const submit = async() =>{
  ...
  const res = await banner.insertBanner(formData);
  if(res.result){
    router.push({name:'banners-list'})
    notification.Success(`Banner Added Successfully`);
  }else{
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-end">
            ...
            <button type="button" class="btn btn-info" @click.prevent="submit" v-else>Add Banner</button>
          </div>
        </div>
      </div>
      <!-- /.card -->
