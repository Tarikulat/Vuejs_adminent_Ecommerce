<script setup>
import { useSubCategories, useNotification, useCategories } from '@/stores';
...
const submit = async() =>{
  ...
  const res = await subCategory.insertSubCategory(formData);
  if(res.result){
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-info" v-if="subCategory.addLoading"><i class="fas fa-spinner fa-spin"></i> Loading...</button>
            <button type="button" class="btn btn-info" @click.prevent="submit" v-else>Add Sub-Category</button>
          </div>
        </div>
      </div>
      <!-- /.card -->
