...
const getSingleCategoryData = async() =>{
    let res = await category.getSingleCategoryData(route.params.id);
    if(res.result){
...
const submit = async() =>{
  ...
  const res = await category.updateCategory(route.params.id, formData);
  if(res.result){
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-info" v-if="category.loading"><i class="fas fa-spinner fa-spin"></i> Loading...</button>
